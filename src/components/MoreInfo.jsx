  ...
  return (
    <Collapsible open={showMoreInfo} onOpenChange={setShowMoreInfo} className="w-full mt-4">
      <CollapsibleTrigger asChild>
        <Button
          variant="outline"
          className="w-full flex items-center justify-between text-gray-700 hover:text-gray-900 hover:bg-gray-100 focus:ring-1 focus:ring-gray-300 focus:outline-none transition-colors duration-200"
        >
      ...
      <CollapsibleContent className="mt-2">
        <div className="p-4 rounded-md bg-white border border-gray-300 text-gray-700 shadow-sm">
          <p className="text-sm">
